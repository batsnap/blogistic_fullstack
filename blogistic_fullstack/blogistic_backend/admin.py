...
class orderAdmin(admin.ModelAdmin):
    list_display = ('id_order','name_client','name_operator','name_worker','addressPV','addressPD','date','time_in','count_objects','weight','type_thing','confirmation_order','price','type_pay','status_order')
    ordering=('id_order',)
